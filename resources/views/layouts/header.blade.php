      ...
      @else
        ...
        <ul class="navbar-nav mx-auto mb-3 mb-lg-0 stc-nav-links">
          ...
          <div class="stc-nav-icon-group">
            <a href="{{ Auth::check() ? route('profile.index') : route('login') }}" class="stc-nav-icon" aria-label="Cuenta">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            </a>
            
            @auth
            <a href="{{ route('wishlist.index') }}" class="stc-nav-icon stc-nav-icon-wrapper" aria-label="Favoritos">
            ...
            <a href="{{ route('cart.index') }}" class="stc-nav-icon stc-nav-icon-wrapper" aria-label="Carrito">
